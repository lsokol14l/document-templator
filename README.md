...
![Добавление приложения](images/appendix_add.png)
![Список приложений](images/appendix_list.png)
...
#### Документ с несколькими приложениями

![Результат с приложениями](images/result_w_appendix2.png)
![Результат с приложениями - вторая страница](images/result_w_appendix3.png)
...
- 🎨 **Удобный UI** — интуитивный интерфейс с подсказками для каждого поля
...
- Поддержка загрузки нескольких шаблонов
- История последних операций
- Предпросмотр документа перед сохранением
- Экспорт в PDF
- Сохранение профилей данных (шаблоны адресатов)
- Добавление изображений в приложения
- Поддержка таблиц в приложениях
- Расчет количества страниц автоматически
- Подписание документов цифровой подписью

## Автор

Разработано как лабораторные работы в рамках курса "Функциональное программирование и логическое программирование"

---

**Статус**: ✅ Оба проекта завершены и работают корректно
