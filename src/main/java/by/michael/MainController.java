...
public class MainController {
    ...
    // Реквизиты письма
    @FXML
    private TextField letterDateField;
    @FXML
    private TextField letterNumberField;

    // Адресат
    @FXML
    private TextField recipientPostField;
    @FXML
    private TextField recipientOrganizationField;
    @FXML
    ...
    // Содержание
    @FXML
    private TextArea letterBodyArea;
    @FXML
    private TextArea appendixListArea;

    // Отправитель
    @FXML
    private TextField senderPostField;
    @FXML
    ...
    @FXML
    private TextField executorPhoneField;
